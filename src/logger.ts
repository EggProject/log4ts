 ...
 * use {@see Log4TS#getLogger(String)} to get an instance.
 */
import {Level} from './level';
import {DateFormatter} from './date-formatter';
import {Log4TS} from './log4js';
...
export class Logger {
    ...
    /** level to be logged */
    private level = Level.FATAL;

    private dateformat = DateFormatter.DEFAULT_DATE_FORMAT;
    private dateformatter = new DateFormatter();

    private onlog = new CustomEvent();
    private onclear = new CustomEvent();
    ...
    constructor(private name: string) {
        ...
        this.appenders.push(new Log4TS.Appender(this));
