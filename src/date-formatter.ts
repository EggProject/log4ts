...
export class DateFormatter {
     ...
     */
    public static readonly DEFAULT_DATE_FORMAT = "yyyy-MM-ddThh:mm:ssO";
     ...
     */
    static formatDate(vDate, vFormat) {
     ...
     * @return {String} formatted date string
     */
    static formatUTCDate(vDate, vFormat) {
    ...
    private static addZero(vNumber) {
